...
$query="SELECT * FROM buku WHERE tingkatan = 'SMP'"; 
...
$penulis_buku=$row['author'];
$desc_buku=$row['deskripsi'];
...
$fp = fopen('data-api-smp.json', 'w');
fwrite($fp, json_encode($response, JSON_PRETTY_PRINT));
fclose($fp);
header( 'Location: http://localhost/yuubaca/app/Api/data-api-smp.json' ) ;
?> 